        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="mb-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p>ברוכים הבאים ל-oFair! פלטפורמה חדשנית שמחברת בין צרכנים לנותני שירות, מאפשרת דירוגים אמינים, הזמנת שירותים בקלות, וקבלת הצעות מחיר חכמות. השימוש בפלטפורמה מהווה הסכמה לתנאים המפורטים להלן.</p>
              ...
              <ul className="list-disc pr-6 space-y-2">
                ...
                <li><strong>"נותן שירות"</strong> – ספק שירות הרשום במערכת ומציע שירותים לצרכנים.</li>
              </ul>

              <h2 className="text-2xl font-bold mt-8 mb-4">3. מטרת הפלטפורמה</h2>
              <ul className="list-disc pr-6 space-y-2">
                <li>לאפשר ללקוחות למצוא נותני שירות מדורגים ואמינים.</li>
                <li>לאפשר לצרכנים לדרג נותני שירות ולסייע לשיפור השירות הכללי.</li>
                <li>לאפשר קבלת הצעות מחיר מכמה נותני שירות ולהשוות ביניהם.</li>
              </ul>

              <h2 className="text-2xl font-bold mt-8 mb-4">4. הרשמה ושימוש בפלטפורמה</h2>
              <ul className="list-disc pr-6 space-y-2">
                <li>הרישום חינם ופתוח לכל אדם מעל גיל 18.</li>
                <li>בהרשמתך לפלטפורמה, אתה מאשר את הסכמתך לקבלת עדכונים, הצעות מנותני שירות והתראות רלוונטיות, כולל הודעות דרך וואטסאפ.</li>
              ...
              <p>משתמשי הפלטפורמה רשאים לדרג נותני שירות על בסיס חוויית השירות שקיבלו.</p>
              ...
              <ul className="list-disc pr-6 space-y-2">
                <li>משתמשים יכולים להשאיר פנייה למספר נותני שירות ולקבל מהם הצעות מחיר להשוואה.</li>
                <li>oFair אינה אחראית לאיכות העבודה או לתנאי ההתקשרות עם נותני השירות – האחריות הבלעדית חלה על נותן השירות והלקוח.</li>
              </ul>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4">8. מבצע השקה – 50 שקל חזרה על העבודה הראשונה</h2>
              <ul className="list-disc pr-6 space-y-2">
                <li>צרכנים אשר יבצעו עסקה ראשונה דרך הפלטפורמה ויתנו דירוג יקבלו <strong>50 שקל חזרה</strong>.</li>
                <li>החזר הכספי יתבצע ישירות <strong>לתוך המערכת כהטבה להזמנה הבאה</strong> דרך הפלטפורמה, ויהיה תקף לשימוש למשך <strong>שנה שלמה</strong> מרגע קבלתו. תהליך ההחזר לתוך המערכת יתבצע תוך 14 ימי עסקים מסיום העסקה ודירוג נותן השירות.</li>
              ...
              <ul className="list-disc pr-6 space-y-2">
                <li>הפלטפורמה משמשת כמתווך בלבד ואינה אחראית לאיכות השירותים המסופקים על ידי נותני השירות.</li>
                <li>כל התקשרות עם נותני שירות נעשית באחריות המשתמש בלבד.</li>
                <li>הפלטפורמה שומרת לעצמה את הזכות להסיר משתמשים או נותני שירות שאינם עומדים במדיניות השירות.</li>
              </ul>
