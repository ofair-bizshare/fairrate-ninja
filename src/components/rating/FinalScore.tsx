...
const FinalScore: React.FC<FinalScoreProps> = ({ weightedAverage }) => {
  const isExcellent = weightedAverage >= 4.2;
    ...
    <div className="mt-8 pt-6 border-t border-gray-100">
      <div className="flex flex-col items-center justify-center gap-2">
        ...
        <div className="flex items-center gap-2">
          <span className={`text-3xl font-bold ${isExcellent ? 'text-primary' : 'text-red-500'}`}>
        ...
        <div className="text-xs text-muted-foreground rtl text-center max-w-xs mx-auto mt-1">
